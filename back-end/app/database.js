        ...
        */ 
        ...
        (err) => {
            if (err) {
                ...
                db.run(insert, ["Ponto 4","#42f56c","-23", "-53"])
                db.run(insert, ["Ponto 5","#42f56c","-24", "-52"])
                db.run(insert, ["Ponto 6","#42f56c","-25", "-51"])
                db.run(insert, ["Ponto 7","#42f56c","-26", "-50"])
                db.run(insert, ["Ponto 8","#42f56c","-27", "-49"])
                db.run(insert, ["Ponto 9","#42f56c","-28", "-48"])
